...
/**
 * Сервлет за брисање профилне слике. 
 * @author mirko 
 * @version 1.0
 */
@WebServlet("/DeleteProfileImageServlet")
public class DeleteProfileImageServlet extends HttpServlet {
    ...
    public DeleteProfileImageServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			controller.getRegistrator(request.getSession()).getUserDataLink().updateProfilePicture(username, null); 
