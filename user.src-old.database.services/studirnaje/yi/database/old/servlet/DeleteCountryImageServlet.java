...
/**
 * Сервлет за брисање иформације заставице државе која је постављена 
 * за корисника. 
 */
@WebServlet("/DeleteCountryImageServlet")
public class DeleteCountryImageServlet extends HttpServlet {
    ...
    public DeleteCountryImageServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			controller.getRegistrator(request.getSession()).getUserDataLink().updateCountryFlagPicture(username, null); 
