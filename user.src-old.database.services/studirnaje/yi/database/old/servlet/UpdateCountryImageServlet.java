...
/**
 * Servlet implementation class UpdateCountryImageServlet
 */
@WebServlet("/UpdateCountryImageServlet")
public class UpdateCountryImageServlet extends HttpServlet {
    ...
    public UpdateCountryImageServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			controller.getRegistrator(request.getSession()).getUserDataLink().updateCountryFlagPicture(username, imageFileName); 
