...
/**
 * Постављање информације о профилној слици у базу подтака. 
 */
...
public class UpdateProfileImageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			controller.getRegistrator(request.getSession()).getUserDataLink().updateProfilePicture(username, imageFileName); 
